...
export default function JuegoInfo() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Contenido principal */}
      <div className="flex-grow flex justify-center items-center bg-cover bg-center" style={{ backgroundImage: `url(${wood})` }}>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-stretch gap-12">
            ...
            <div className="relative group md:w-1/2">
              <img
                ...
                className="object-contain rounded-lg shadow-lg transition-transform duration-300 group-hover:scale-105 w-full h-full"
                style={{ maxHeight: '50vh' }} // ajusta para ver la imagen completa sin recortar
              />
